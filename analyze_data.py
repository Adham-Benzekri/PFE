...
def analyze_downtime_impact(data_path):
    ...
    summary.to_csv('impact_cause_arret.csv', index=False)

    print("Impact de chaque cause d'arrêt sur l'efficacité de production (en pourcentage):")
    print(summary)

    return summary

if __name__ == "__main__":
    cleaned_data_path = 'data_nettoye.csv'
